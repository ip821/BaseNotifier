...
EXTERN_PROXY_FILE( objectstore_contract_i )
EXTERN_PROXY_FILE( objmdl_contract_i )
EXTERN_PROXY_FILE( settings_contract_i )
...
/* Start of list */
  ...
  REFERENCE_PROXY_FILE( objectstore_contract_i ),
  REFERENCE_PROXY_FILE( objmdl_contract_i ),
  REFERENCE_PROXY_FILE( settings_contract_i ),
